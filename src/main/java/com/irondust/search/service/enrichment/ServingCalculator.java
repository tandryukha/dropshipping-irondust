...
public class ServingCalculator implements EnricherStep {
    ...
    public EnrichmentDelta apply(RawProduct raw, ParsedProduct soFar) {
        ...
        // If servings is missing but we have net_weight_g and serving_size_g, calculate it
        if (soFar.getServings() == null && soFar.getNet_weight_g() != null && soFar.getServing_size_g() != null) {
